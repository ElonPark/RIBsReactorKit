...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Nimble/_Prebuilt/Nimble.framework"
  install_framework "${PODS_ROOT}/RxBlocking/_Prebuilt/RxBlocking.framework"
  install_framework "${PODS_ROOT}/RxTest/_Prebuilt/RxTest.framework"
fi
