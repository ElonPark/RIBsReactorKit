...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Differentiator/_Prebuilt/Differentiator.framework"
  install_framework "${PODS_ROOT}/EPLogger/_Prebuilt/EPLogger.framework"
  install_framework "${PODS_ROOT}/Kingfisher/_Prebuilt/Kingfisher.framework"
  install_framework "${PODS_ROOT}/Moya/_Prebuilt/Moya.framework"
  install_framework "${PODS_ROOT}/NeedleFoundation/_Prebuilt/NeedleFoundation.framework"
  install_framework "${PODS_ROOT}/RIBs/_Prebuilt/RIBs.framework"
  install_framework "${PODS_ROOT}/ReachabilitySwift/_Prebuilt/Reachability.framework"
  install_framework "${PODS_ROOT}/ReactorKit/_Prebuilt/ReactorKit.framework"
  install_framework "${PODS_ROOT}/RxCocoa/_Prebuilt/RxCocoa.framework"
  install_framework "${PODS_ROOT}/RxDataSources/_Prebuilt/RxDataSources.framework"
  install_framework "${PODS_ROOT}/RxReachability/_Prebuilt/RxReachability.framework"
  install_framework "${PODS_ROOT}/RxRelay/_Prebuilt/RxRelay.framework"
  install_framework "${PODS_ROOT}/RxSwift/_Prebuilt/RxSwift.framework"
  install_framework "${PODS_ROOT}/RxViewController/_Prebuilt/RxViewController.framework"
  install_framework "${PODS_ROOT}/SkeletonView/_Prebuilt/SkeletonView.framework"
  install_framework "${PODS_ROOT}/SnapKit/_Prebuilt/SnapKit.framework"
  install_framework "${PODS_ROOT}/WeakMapTable/_Prebuilt/WeakMapTable.framework"
fi
